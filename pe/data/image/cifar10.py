...
class Cifar10(Data):
    ...
    def __init__(self, split="train"):
        ...
        # Since we donnot have to download the file everytime, we store the CIFFAR10 dataset locally. 
        # with tempfile.TemporaryDirectory() as tmp_dir:
        #     dataset = torchvision.datasets.CIFAR10(root=tmp_dir, train=train, download=True)

        # The following line gurantee downloading once.
        dataset_dir = os.path.expanduser('~/.torch/datasets')
        dataset = torchvision.datasets.CIFAR10(root=dataset_dir, train=train, download=True)
